...
export class UploadPost {
  ...
  _addCommonParams(form, options) {
    ...
    if (options.autogenerate !== undefined) form.append('autogenerate', String(options.autogenerate));
    if (options.autogenerateTitle !== undefined) form.append('autogenerate_title', String(options.autogenerateTitle));
    if (options.autogenerateDescription !== undefined) form.append('autogenerate_description', String(options.autogenerateDescription));
    if (options.autogenerateLanguage) form.append('autogenerate_language', String(options.autogenerateLanguage));
